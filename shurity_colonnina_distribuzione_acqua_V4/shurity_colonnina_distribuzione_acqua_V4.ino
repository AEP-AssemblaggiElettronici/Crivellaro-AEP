...
// ============================================
#define AUTO_RETURN_TIMEOUT_MS 5000  // 5 secondi di inattività
...
void callback_bottone_impostazioni_allarme(lv_event_t *evento) {
  safe_lvgl_operation([&]() {
    ...
    lv_obj_align(label_freq, LV_ALIGN_CENTER, -150, 145);
    ...
    lv_obj_align(btn_snooze_clear, LV_ALIGN_BOTTOM_MID, 0, -10);
...
void controlla_auto_ritorno() {
  ...
  if (now - last_touch_time > AUTO_RETURN_TIMEOUT_MS) {
    ...
    disable_auto_return();
    safe_lvgl_operation([&]() {
      lv_scr_load_anim(schermo1, LV_SCR_LOAD_ANIM_FADE_IN, 300, 0, false);
    });
  }
}
...
void callback_bottone_impostazioni_schermo(lv_event_t *evento) {
  safe_lvgl_operation([&]() {
    ...
    // Abilita auto-ritorno per questa schermata
    enable_auto_return();
