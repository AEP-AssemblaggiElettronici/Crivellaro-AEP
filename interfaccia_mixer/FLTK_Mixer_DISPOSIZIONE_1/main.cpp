...
#define DISTANZA_PULSANTE_MIXER 320
...
Fl_Window *finestra = new Fl_Window (1400, 550);
BottoneMixer *bottoni[NUMERO_BOTTONI];
BottoneBanco *bottoniBanco[NUMERO_BOTTONI_CANALI];
Fl_Button *bottoneCarica = new Fl_Button(1000, 470, 130, 50, "LOAD");
Fl_Button *bottoneSalva = new Fl_Button(1200, 470 , 130, 50, "SAVE");
