...
// funzione per quanto un bottone è selezionato, lo indica con sfondo giallo
void BottoneBanco::set_selezione(bool tempSelezionato)
{
  selezionato = tempSelezionato;
  this->color(tempSelezionato ? FL_YELLOW : FL_GRAY);
  this->redraw();
}
