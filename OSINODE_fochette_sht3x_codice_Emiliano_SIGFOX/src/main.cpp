...
da 1 byte (8 bit) ciascuno.
  ...
  - Il dodicesimo byte è una sigla (ED) di chiusura dell'array(oppure che può anche indicare il tipo di sensori collegati).
...
void loop()
{
  ...
  for (int i = 0; i < 112; i++)
  { // 15minuti*60secondi=900secondi/8secondi=112 iterazioni
