#define DEBUG 0 // MODALITA DEBUG (1 attiva, 0 disattivata)
...
#define TEMPO_LORA 75   // 5 minuti
#define TEMPO_SIGFOX 225 // 15 minuti

#define COSTANTE_C 250 // costanti di peso
#define COSTANTE_D 250

#define UNA_ORA 3600000 // un'ora in millisecondi
#define TEMPO_SLEEP_LORA 300000
#define TEMPO_SLEEP_SIGFOX 900000
#define SOGLIA_FREDDO 20