...
void callback_bottone_impostazioni_allarme(lv_event_t *evento) {
  safe_lvgl_operation([&]() {
    ...
    lv_obj_align(label_slider, LV_ALIGN_CENTER, 0, -5);

    // Slider per limite mesi con bottoni agli estremi
    ...
    lv_obj_set_height(slider_limite_mesi, 25);
    lv_obj_align(slider_limite_mesi, LV_ALIGN_CENTER, 0, 25);
    lv_obj_set_style_bg_color(slider_limite_mesi, lv_color_hex(0x0F73B5), LV_PART_INDICATOR);
    lv_obj_add_event_cb(slider_limite_mesi, slider_limite_mesi_cb, LV_EVENT_VALUE_CHANGED, NULL);

    // Bottoni + e - per limite mesi agli estremi
    lv_obj_t *btn_plus_mesi, *btn_minus_mesi;
    crea_bottoni_plus_minus_estremi(schermo_filtri, slider_limite_mesi, &btn_plus_mesi, &btn_minus_mesi);
    lv_obj_add_event_cb(btn_plus_mesi, btn_plus_cb, LV_EVENT_CLICKED, NULL);
    lv_obj_add_event_cb(btn_minus_mesi, btn_minus_cb, LV_EVENT_CLICKED, NULL);

    // Label limite mesi sotto lo slider
    label_limite_mesi = lv_label_create(schermo_filtri);
    lv_obj_align_to(label_limite_mesi, slider_limite_mesi, LV_ALIGN_OUT_BOTTOM_MID, 0, 5);
    ...
    lv_obj_align(label_switch, LV_ALIGN_CENTER, -70, 110);

    switch_controllo_automatico = lv_switch_create(schermo_filtri);
    lv_obj_align(switch_controllo_automatico, LV_ALIGN_CENTER, 70, 110);
    lv_obj_set_style_bg_color(switch_controllo_automatico, lv_color_hex(0x0F73B5), LV_PART_INDICATOR | LV_STATE_CHECKED);
...
void setup() {
  ...
  if (!safe_lvgl_operation([&]() {
        ...
        lv_obj_set_size(cerchio_selezione, SIZE_ICON_BIG, SIZE_ICON_BIG);  // Stesso diametro delle icone
        lv_obj_set_style_radius(cerchio_selezione, LV_RADIUS_CIRCLE, 0);
        lv_obj_set_style_bg_color(cerchio_selezione, lv_color_hex(0x0F73B5), 0);  // NUOVO COLORE BLU
...
void callback_bottone_impostazioni_schermo(lv_event_t *evento) {
  safe_lvgl_operation([&]() {
    ...
    lv_obj_set_width(slider_ore, 250);  // Ridotto per fare spazio ai bottoni
    lv_obj_set_height(slider_ore, 25);
    lv_obj_align(slider_ore, LV_ALIGN_CENTER, 0, -40);  // Centrato
    ...
    lv_obj_set_width(slider_minuti, 250);  // Ridotto per fare spazio ai bottoni
    lv_obj_set_height(slider_minuti, 25);
    lv_obj_align(slider_minuti, LV_ALIGN_CENTER, 0, 20);  // Centrato
...
void callback_bottone_impostazioni_erogazione(lv_event_t *evento) {
  safe_lvgl_operation([&]() {
    ...
    lv_obj_align(slider_bicchiere_erogazione, LV_ALIGN_CENTER, 0, -80);
    ...
    lv_obj_align(slider_bottiglia_erogazione, LV_ALIGN_CENTER, 0, 40);
